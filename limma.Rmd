...
**Citations**: 
    * [Smyth et al. (2004)](http://www.ncbi.nlm.nih.gov/pubmed/16646809) 
    * [Ritchie et al. (2015)](http://nar.oxfordjournals.org/content/early/2015/02/10/nar.gkv007)
...
* `lmFit()` = estimates a linear model for each gene. Also calculates the residual error. 
    * Needs to inputs: (1) expression matrix and (2) design matrix. Outputs an `MArrayLM` object. 
...
* `plotSA()` = Plots the variance vs A-values to check for variance across intensity levels
